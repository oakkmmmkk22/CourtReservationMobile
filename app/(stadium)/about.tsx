...
export default function App() {
    ...
    return (
      <View style={styles.container} >
        ...
        {/* <MapView
            style={{
            width: 400,    // Set the width of the mini map
            height: 300,   // Set the height of the mini map
            borderRadius: 100, // Optional: Round corners of the mini map
            marginBottom: 100, // Optional: Add space between the mini map and other elements
            }}
            initialRegion={{
            latitude: latitude,
            longitude: longitude,
